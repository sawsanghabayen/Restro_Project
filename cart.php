...
$result=mysqli_query($link,"SELECT food_name,food_description,food_price,food_photo,cart_id,quantity_value,total,flag,category_name FROM salaries,food_details,cart_details,categories,quantities
 WHERE food_details.food_salary=salaries.salary_id And cart_details.member_id='$member_id' 
