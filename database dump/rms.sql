...
INSERT INTO `salaries` (`salary_id`, `food_price`) VALUES
(15, 400),
(16, 200);
--
...
CREATE TABLE `food_details` (
  ...
  `food_salary` int(15) NOT NULL,
  `food_Calories` int(15) NOT NULL,
...
INSERT INTO `food_details` (`food_id`, `food_name`, `food_description`, `food_salary`,`food_Calories`, `food_photo`, `food_category`) VALUES
(24, 'Pasta', ' It is a form of short-cut pasta, shaped like a large grain of rice', 16, 192,'orzo.jpg', 15),
(25, 'Burger', 'It is a sandwich consisting of one or more cooked patties of ground meat, usually beef, placed inside a sliced bread roll or bun. The patty may be pan fried, barbecued, or flame broiled.', 15,158, 'burger.jpg', 15),
(26, 'Sandwich', 'It is a food typically consisting of vegetables, sliced cheese or meat, placed on or between slices of bread, or more generally any dish wherein two or more pieces of bread serve as a container or wrapper for another food type.', 16,160, 'sandwich.jpg', 15);
...
--
ALTER TABLE `salaries`
  MODIFY `salary_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
