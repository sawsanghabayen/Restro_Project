    ...
    if(isset($_POST['quantity']) && isset($_POST['item']))
        {
            ...
            $result=mysqli_query($link,"SELECT * FROM salaries,food_details,cart_details WHERE food_details.food_salary=salaries.salary_id  AND cart_details.member_id='$member_id' AND cart_details.flag='$flag_0' AND cart_details.food_id=food_details.food_id AND cart_details.cart_id='$cart_id'") or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours."); 
